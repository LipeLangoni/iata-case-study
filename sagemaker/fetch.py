...
def parse_args():
    ...
    parser.add_argument(
        ...
        type=str,
        required=True,
        help="The HTTP URL of the zip file to download",
    )
    parser.add_argument(
        "--s3_bucket",
        type=str,
        required=True,
        help="The S3 bucket where the files will be uploaded",
    )
    parser.add_argument(
        "--s3_prefix",
        type=str,
        required=True,
        help="The prefix in the S3 bucket where the files will be uploaded",
    )
